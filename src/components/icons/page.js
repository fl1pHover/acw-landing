export function IconMoney({ className }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="m.911 40.525h37.447v-21.434h-37.447zm3.445-15.4a3.007 3.007 0 0 0 3.007-3.008h24.542a3.008 3.008 0 0 0 3.008 3.008v9.358a3.008 3.008 0 0 0 -3.008 3.008h-24.542a3.007 3.007 0 0 0 -3.007-3.008z"></path>
      <circle cx="19.634" cy="29.808" r="4.512"></circle>
      <path d="m2.878 17.59h36.983v17.3l3.02-.32-2.24-21.31z"></path>
      <path d="m42.871 7.49-37.964 8.014 37.064-3.894 1.86 17.68 3.08-.74z"></path>
    </svg>
  );
}
...
export function IconFast({ className }) {
  return (
    <svg
      id="fi_8201111"
